...
import FormCreateProduct from '@/components/fragments/Admin/FormCreateProduct';
import ProductsList from '@/components/fragments/Admin/ProductsList';
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <Dialog open={open} onOpenChange={setOpen}>
                    ...
                    <FormCreateProduct onSuccess={() => setOpen(false)} />
                  </Dialog>
                </div>
              </div>
